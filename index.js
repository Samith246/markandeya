...
app.post('/submit', upload.array('image', 10), (req, res) => {
    ...
    const sql = 'INSERT INTO cars (car_brand, model, numberplate, price, engine_capacity, horsepower, torque, mileage, fuel_type, transmission, registration_year, kms_driven, bodytype, ownership, image, booking_amount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
    const values = [
        formData.carBrand,
        formData.model,
...
app.post('/edit/:id', (req, res) => {
    ...
    const sql = 'UPDATE cars SET car_brand = ?, model = ?,numberplate = ?, price = ?, engine_capacity = ?, horsepower = ?, torque = ?, mileage = ?, fuel_type = ?, transmission = ?, registration_year = ?, kms_driven = ?, bodytype = ?, ownership = ?, booking_amount = ? WHERE id = ?';
    const values = [
...
app.post('/soldout/:id', (req, res) => {
    ...
    connection.query(fetchCarQuery, [carId], (err, results) => {
        ...
        const insertSoldOutCarQuery = 'INSERT INTO soldout_cars (id, car_brand, model, numberplate, price, engine_capacity, horsepower, torque, mileage, fuel_type, transmission, registration_year, kms_driven, bodytype, ownership, image, status, booking_amount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
...
app.post('/notsold/:id', (req, res) => {
    ...
    connection.query(fetchSoldOutCarQuery, [carId], (err, results) => {
        ...
        const insertCarQuery = 'INSERT INTO cars (id, car_brand, model, numberplate, price, engine_capacity, horsepower, torque, mileage, fuel_type, transmission, registration_year, kms_driven, bodytype, ownership, image, status, booking_amount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
        const carValues = [
            car.id,
            car.car_brand,
            car.model,
...
app.post('/approve-seller/:id', (req, res) => {
    ...
    connection.query(fetchSellerQuery, [sellerId], (err, results) => {
        ...
        const carValues = [
            ...
            seller.bodytype,
            seller.ownership,
            seller.images // Assuming image paths are stored as comma-separated strings
        ];
